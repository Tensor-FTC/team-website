 ...
 * Upstream: src/ts-tailwind/DecryptedText.tsx in github.com/DavidHDev/react-bits.
 *
 ...
 *
 * Local edit: the visually hidden copy renders the settled `text` instead of
 * the mid-scramble `displayText`, so screen readers announce the real word
 * once rather than a stream of noise.
 */
